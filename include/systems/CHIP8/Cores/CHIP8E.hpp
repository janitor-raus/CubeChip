...
class CHIP8E final : public IFamily_CHIP8 {
	...
	static constexpr std::string_view c_supported_extensions[] = { ".ch8", ".c8e" };
...
public:
	static constexpr SystemDescriptor descriptor = {
		...
		"CHIP-8E", "chip8e", "CHIP-8E core derived from the original spec.",
...
/*==================================================================*/
	...
	void instruction_5xy1(u32 X, u32 Y) noexcept;
...
/*==================================================================*/
	...
	void instruction_BBNN(u32 NN) noexcept;
	void instruction_BFNN(u32 NN) noexcept;
...
/*==================================================================*/
	...
	void instruction_Fx03(u32 X) noexcept;
	...
	void instruction_Fx1B(u32 X) noexcept;
	// FX1E - set I = I + VX
	...
	void instruction_Fx4F(u32 X) noexcept;
	...
	void instruction_FxE3(u32 X) noexcept;
	// FxE7 - read content of input port 3 to VX without waiting for strobe
	void instruction_FxE7(u32 X) noexcept;
