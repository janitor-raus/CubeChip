...
public:
	FrameMetadata(ez::s32 W, ez::s32 H) noexcept
	...
	FrameMetadata(const FrameMetadata&) = default;
	FrameMetadata& operator=(const FrameMetadata& other) noexcept {
		if (this != &other) {
			set_viewport(
